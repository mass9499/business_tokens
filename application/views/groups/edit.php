                  ...
                  <table class="table table-responsive">
                    ...
                    <tbody>
                      ...
                      <tr>
                       ...
                       <tr>
                        <td>Tokens</td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="createToken" <?php 
                        if($serialize_permission) {
                          if(in_array('createToken', $serialize_permission)) { echo "checked"; }  
                        }
                         ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="updateToken" <?php 
                        if($serialize_permission) {
                          if(in_array('updateToken', $serialize_permission)) { echo "checked"; }  
                        }
                         ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="viewToken" <?php 
                        if($serialize_permission) {
                          if(in_array('viewToken', $serialize_permission)) { echo "checked"; }  
                        }
                         ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="deleteToken" <?php 
                        if($serialize_permission) {
                          if(in_array('deleteToken', $serialize_permission)) { echo "checked"; }  
                        }
                         ?>></td>
                      </tr>
