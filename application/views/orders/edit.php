          ...
          <form role="form" action="<?php base_url('orders/create') ?>" method="post" class="form-horizontal">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label class="col-sm-6">Customer Name &nbsp; &nbsp; &nbsp; &nbsp; : &nbsp; <input type="text" name="customername" value="<?php echo $order_details['customer_name']; ?>" style="padding:5px 0px; width:50%; border-radius:3px; border:1px solid #e2e2e2;"></label>
                  <label for="gross_amount" class="col-sm-6 control-label">Date :  &nbsp; <?php echo date('Y-m-d') ?></label>
                </div>
                <div class="form-group">
                  <label class="col-sm-6">Customer Number &nbsp;&nbsp; : &nbsp; <input type="number" name="customernumber" value="<?php echo $order_details['customer_number']; ?>" style="padding:5px 0px; width:50%; border-radius:3px; border:1px solid #e2e2e2;"></label>
