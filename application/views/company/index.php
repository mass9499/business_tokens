      ...
      <div class="row">
        <div class="col-md-12 col-xs-12">
          ...
          <div class="box">
            ...
            <form enctype="multipart/form-data" role="form" action="<?php base_url('company/update') ?>" method="post">
            ...
            <!--<div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <?php if($company_data['logo_path'] != '') { ?>
                    <img src="<?php echo base_url(); ?><?php echo $company_data['logo_path']; ?>" style="width:70px; height:70px;" />
                  <?php } ?>
                  <input type="file" class="form-control" id="company_logo" name="company_logo" autocomplete="off">
                </div>
                
                <div class="form-group">
                  <label for="country">Maximum Occupancy</label>
                  <input type="text" class="form-control" id="maxocc" name="maxocc" placeholder="Enter maximum occupancy" value="<?php echo $company_data['maxocc'] ?>" autocomplete="off">
                </div>
